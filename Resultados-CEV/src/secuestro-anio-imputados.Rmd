...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/secuestro-anio-documentado.html) sobre la obtención de víctimas documentadas para esta misma variable 
...
tabla_documentada <-  arrow::read_parquet(here::here("Resultados-CEV/output-documentados/secuestro-anio-documentado.parquet"))
...
con los patrones de violencia a partir de la [estimación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/secuestro-anio-estimacion.html) y posterior [combinacion](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/secuestro-anio-documentado.html).

```{r save-observed, echo = TRUE}

arrow::write_parquet(tabla_combinada,
                     here::here("Resultados-CEV/output-imputados/secuestro-anio-imputados.parquet"))
```
