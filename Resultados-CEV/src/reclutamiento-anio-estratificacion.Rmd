...
subtitle: "Reclutamiento a menores de edad desagregado por año del hecho - 1990–2017"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
las combinaciones (nombres) de nuestras variables.
...
de datos, como la réplica 6) y por último definimos los nombres de esas agrupaciones
las cuales muestran todas las combinaciones entre estas dos variables (por ejemplo
lo que muestra *replica6_grupo6_estrato*).
...
saveRDS(resultados, 
        here::here("Resultados-CEV/output-estratificacion/reclutamiento-yy_hecho-edad_c.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/reclutamiento-anio-estimacion.html)