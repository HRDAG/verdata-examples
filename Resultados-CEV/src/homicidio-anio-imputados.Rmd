...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/homicidio-anio-documentado.html) sobre la obtención de víctimas documentadas para esta misma variable 
...
tabla_documentada <-  arrow::read_parquet(here::here("Resultados-CEV/output-documentados/homicidio-anio-documentado.parquet"))
...
que efectivamente fueron víctimas dentro del marco del conflicto, pero, ¿qué 
...
determinó que si pertenecen al conflicto.
...
con los patrones de violencia a partir de la [estimación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/homicidio-anio-estimacion.html) y posterior [combinacion](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/homicidio-anio-documentado.html).

```{r save-observed, echo = TRUE}

arrow::write_parquet(tabla_combinada,
                     here::here("Resultados-CEV/output-imputados/homicidio-anio-imputados.parquet"))
```
