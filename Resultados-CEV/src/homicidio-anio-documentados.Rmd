...
subtitle: "Homicidio desagregado por año del hecho - 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
los datos documentados. Se observa entonces que el año 2002 es el año con más
homicidios documentados (`r myNum(tabla_documentada$observed[1])` víctimas), seguido 
del año 2001 (`r myNum(tabla_documentada$observed[2])` víctimas), 2000 
...
información (junto con la ya documentada) se abordará en el [próximo ejemplo sobre imputación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/homicidio-anio-imputado.html)
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/output-documentados/homicidio-anio-documentado.parquet"))
