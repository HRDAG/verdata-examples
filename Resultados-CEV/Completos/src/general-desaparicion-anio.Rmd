...
por `is_conflict` == 1 e `is_forced_dis` == 1. 
...
año, la estratificación se hace por la variable **yy_hecho** y la variable de 
**is_forced_dis** para cada réplica. 
...
`r myNum(estimates_tabla$N_025[18])` y `r myNum(estimates_tabla$N_975[18])` con
