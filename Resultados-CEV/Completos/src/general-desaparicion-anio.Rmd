...
las víctimas de desaparición en 2007 presentes en la réplica 4:

```{r stratify-continuacion2, echo = TRUE}

datos <- listas[["strata_data"]]

replica4_2007 <- datos[[151]]

paged_table(replica4_2007, options = list(rows.print = 10, cols.print = 5))
...
contiene una columna con la réplica (R4) y una columna con el año (2007). 
...
replica4_2007_nombre <- nombres[[151]]

paged_table(replica4_2007_nombre, options = list(rows.print = 10, cols.print = 5))
