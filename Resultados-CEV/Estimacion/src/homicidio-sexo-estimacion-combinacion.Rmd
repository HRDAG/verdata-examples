...
subtitle: "Víctimas de homicidio desagregadas por sexo de la víctima - 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
vinculadas al conflicto armado por pertenencia étnica (1985–2018). 
...
listas <- readRDS(here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-p_str-sexo-homicidio.rds"))
```
...
arrow::write_parquet(estimacion,
                      here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-p_str-sexo-homicidio.parquet"))
