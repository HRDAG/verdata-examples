...
como queremos estimar el subregistro de la presente violación para aquellas víctimas
vinculadas al conflict armado, se estratificará por año del hecho y la variable de 
"es desaparición forzada" (tal como en el ejemplo completo para estimaciones por 
año). Sin embargo, es necesario filtrar primero por las variables de "pertenece 
al conflicto" `is_conflict` y la anteriormente mencionada `is_forced_dis`.
...
las personas que fueron desaparecidas de forma forzada en el año de 1985
...
saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-is_conflict-desaparicion.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-is_conflict-estimacion.html).
