...
subtitle: "Reclutamientos a menores de edad desagregados por año del hecho - 1990–2017"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
proceso de estimación del total de víctimas por año del hecho (1990–2017).
...
elemento 151 de la lista contiene las víctimas menores de edad en el año de 1995
presentes en la réplica 5 (ver el objeto **victimas_estrato**):
...
contiene una columna con la réplica (R5), una columna con el año (1995) y la categoría
de edad. Nuevamente, este solo es un ejemplo de nuestra forma de estratificar,
...
saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-edad_c-reclutamiento.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/reclutamiento-anio-estimacion.html).
