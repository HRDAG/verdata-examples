---
title: "Proceso estratificación para estimación de víctimas desagregadas por perpetrador"
...
por lo que se estratificará por año del hecho y perpetrador. Es importante que usted como 
...
como se mencionó, usamos la tabla **replicas_estratos** como primer argumento y 
el objeto **schema** como segundo. Lo que obtenemos es lo siguiente:
...
para cada una de las réplicas. Por ejemplo, el elemento 20 de la lista contiene 
las víctimas secuestradas por los paramilitares en el año de 1992 para la réplica 1
...
victimas_estrato_nombre <- nombres[[20]]
...
saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/perpetrador-secuestro.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/secuestro-perpetrador.html).