...
la nueva categoría de edad. Sin embargo, es necesario filtrar primero por las 
...
tiempo, la variable de es "desaparición forzada" y la categoría de edad. 
...
El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-edad-estimacion.html).
