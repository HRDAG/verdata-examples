...
subtitle: "Víctimas de homicidio desagregadas por año del hecho - 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
En este ejemplo se ilustrará el proceso para obtener la estimación del número
de víctimas por año del hecho. Específicamente, se replicará la figura (sup-der)
...
listas <- readRDS(here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-is_conflict-perpetrador-homicidio.rds"))
```
...
```{r transformacion-mse, echo = TRUE}
