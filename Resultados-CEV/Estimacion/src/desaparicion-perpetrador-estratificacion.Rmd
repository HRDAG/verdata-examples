...
tiempo, la variable de es "desaparición forzada" y la categoría de perpetrador. 
...
El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-perpetrador-estimacion.html).
