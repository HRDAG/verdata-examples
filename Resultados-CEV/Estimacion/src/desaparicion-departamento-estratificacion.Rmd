...
proceso de estimación del total de víctimas por departamento (1985–2016). 
...
Pero, antes de comenzar a estratificar debemos generar algunas variables adicionales. 
...
se estratificará por quinquenio y el departamento del hecho. Sin embargo, es 
necesario filtrar primero por las variables de "pertenece al conflicto"  
`is_conflict` y la anteriormente mencionada `is_forced_dis`.
...
que fueron desaparecidas de forma forzada en el quinquenio de 1985 a 1989 
...
nuestro próximo ejemplo sobre [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-departamento-estimacion.html).

```{r save-estratify, echo = TRUE}

saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-departamento-desaparicion.rds"))
