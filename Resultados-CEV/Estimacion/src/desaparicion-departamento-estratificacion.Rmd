...
**quinquenio** y **departamento del hecho** para cada réplica. El objeto 
...
las víctimas del departamento de Córdoba que fueron desaparecidas de forma 
forzada en el quinquenio de 1985 a 1989 presentes en la réplica 1 
(ver el objeto **victimas_estrato**):
...
El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-departamento-estimacion.html).
