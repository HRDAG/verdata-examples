...
subtitle: "Víctimas de homicidio desagregadas por departamento - 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
vinculadas al conflicto armado por departamento (1985–2018). 
...
listas <- readRDS(here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-departamento-homicidio.rds"))
```
...
arrow::write_parquet(estimacion,
                      here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-departamento-homicidio.parquet"))
