...
proceso de estimación del total de víctimas por etnia (1990–2017).
...
nuevas variables, tal como la variable de "periodo presidencial" para esta 
violación en particular y la variable de "etnia2", la cual agrupa víctimas 
NARP, indígenas y ROM en una categoría denominada "ETNICO":
...
se estratificará por periodo presidencial, etnia2 y sexo. Es importante que usted 
...
**periodo_pres**, **etnia2** y **sexo** para cada réplica. El objeto **schema** contiene una 
...
elemento 100 de la lista contiene las víctimas mujeres (mestizas) menores de 
edad en el periodo 2002-2005, presentes en la réplica 3 (ver el objeto 
...
saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/periodo_pres-etnia2-sexo-reclutamiento.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/reclutamiento-etnia-estimacion.html).
