...
proceso de estimación del total de víctimas por macrorregion de la CEV (1990–2018). 
...
Adicionalmente filtramos por los secuestros ocurridos dentro del marco del 
...
las víctimas de la macrorregion Centro-Andina que fueron secuestradas
en el quinquenio de 2000-2004 presentes en la réplica 1 (ver el objeto 
**victimas_estrato**):
...
próximo ejemplo sobre el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/secuestro-macrorregion-estimacion.html).

```{r save-estratify, echo = TRUE}

saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-macrorregion-secuestro.rds"))
