---
title: "Proceso estratificación para estimación de víctimas desagregadas por etnia"
...
desagregadas por etnia (1990–2018). 
...
como queremos estimar el subregistro de la presente violación por la pertenencia
étnica, por lo que se estratificará por quinquenio, etnia y las macrorregiones 
de la CEV (que las importaremos a continuación):
...
schema <- ("replica,quinquenio,macroregion,etnia")
...
**quinquenio**, **macroregion** y **etnia** para cada réplica. El objeto 
...
contiene las víctimas (desagregadas por etnia) de este hecho en cada uno de los
quinquenios y macrorregiones para cada una de las réplicas. Por ejemplo,
el elemento 10 de la lista contiene las víctimas indígenas de la macrorregión 
centro-andina (en el quinquenio 1990-1994) presentes en la réplica 1 
(ver el objeto **victimas_estrato** y **victimas_estrato_nombre**):
...
saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-macrorregion-etnia-secuestro.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/secuestro-etnia-estimacion.html).