...
subtitle: "Víctimas de homicidio desagregadas por etnia de la víctima - 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
listas <- readRDS(here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-etnia-homicidio.rds"))
```
...
arrow::write_parquet(estimacion,
                      here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-etnia-homicidio.parquet"))
