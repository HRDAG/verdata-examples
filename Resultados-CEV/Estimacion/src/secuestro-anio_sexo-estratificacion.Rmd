...
proceso de estimación del total de víctimas por año del hecho y sexo (1990–2018).
...
El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/secuestro-anio_sexo-estimacion.html).