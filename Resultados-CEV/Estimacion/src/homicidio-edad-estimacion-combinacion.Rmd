...
subtitle: "Víctimas de homicidio desagregadas por edad de la víctima - 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
vinculadas al conflicto armado por edad (1985–2018). 
...
listas <- readRDS(here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-edad-homicidio.rds"))
```
...
arrow::write_parquet(estimacion,
                      here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-edad-homicidio.parquet"))
