---
title: "Proceso estratificación para estimación de víctimas desagregadas por departamento del hecho"
...
como queremos estimar el subregistro de la presente violación por departamento,
se estratificará por quinquenio y el departamento del hecho. Es importante que 
usted como usuario vea que este proceso es netamente artesanal, es decir,
...
schema <- ("replica,quinquenio,dept_code_hecho")
...
**quinquenio** y **dept_code_hecho** para cada réplica. El objeto 
...
contiene las víctimas agrupadas según las variables de estratificación. Por ejemplo, 
el elemento 10 de la lista contiene las víctimas del departamento de Córdoba 
que fueron víctimas en el quinquenio de 1990 a 1994, presentes en la réplica
1 (ver el objeto **victimas_estrato**):
...
tiempo y el departamento. Nuevamente, este solo es un ejemplo de nuestra forma 
...
en nuestra maquina local (con la función `saveRDS`) para usarlo como insumo en 
nuestro próximo ejemplo sobre [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/homicidio-departamento-estimacion.html).

```{r save-estratify, echo = TRUE}

saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-departamento-homicidio.rds"))
