...
proceso de estimación del total de víctimas reclutadas vinculadas al conflicto 
armado (1990–2018).
...
como queremos estimar el subregistro del total de víctimas de la presente violación
se estratificará por periodo presidencial y region. Es importante que usted 
...
schema <- ("replica,periodo_pres,region")
...
**periodo_pres** y **region** para cada réplica. El objeto **schema** contiene una 
...
elemento 1 de la lista contiene las víctimas menores de edad que fueron reclutadas
cerca a la zonas desmilitarizadas durante el periodo 1990 - 1993, 
presentes en la réplica 1 (ver el objeto 
...
saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/periodo_pres-region-reclutamiento.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/reclutamiento-is_conflict-estimacion.html).