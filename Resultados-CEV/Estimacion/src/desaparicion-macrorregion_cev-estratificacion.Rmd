...
subtitle: "Desapariciones forzadas desagregadas por macrorregiones de la CEV - 1985–2016"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
proceso de estimación del total de víctimas por macroregion de la CEV (1985–2016). 
...
la creación de una nueva categoría de tiempo). En este sentido los argumentos de 
...
presente violación por macrorregion, se estratificará por quinquenio y dicha 
variable. Sin embargo, es necesario filtrar primero por las variables de 
"pertenece al conflicto" `is_conflict` y la anteriormente mencionada `is_forced_dis`.
...
las víctimas de la macrorregion Centro-Andina que fueron desaparecidas de forma 
forzada en el quinquenio de 1995 a 1999 presentes en la réplica 1 (ver el objeto 
**victimas_estrato**):
...
próximo ejemplo sobre el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-macrorregion-estimacion.html).

```{r save-estratify, echo = TRUE}

saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-macrorregion-desaparicion.rds"))
