---
title: "Proceso estratificación para estimación del total de víctimas vinculadas al conflicto armado"
...
proceso de estimación del total de víctimas vinculadas al conflicto armado (1990–2018).
...
como queremos estimar el subregistro del total de víctimas de la presente violación, se 
estratificará por año del hecho **yy_hecho**. Es importante que usted como usuario 
...
**yy_hecho** para cada réplica. El objeto **schema** contiene una 
...
para cada una de las réplicas. Por ejemplo, el elemento 151 de la lista contiene 
las víctimas en el año de 1995 presentes en la réplica 5 (ver el objeto
...
saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-is_conflict-secuestro.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/secuestro-is_conflict-estimacion.html).