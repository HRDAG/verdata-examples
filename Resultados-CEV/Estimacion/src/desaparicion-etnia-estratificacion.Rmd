...
tiempo, la variable de es "desaparición forzada" y la categoría de etnia. 
...
El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-etnia-estimacion.html).
