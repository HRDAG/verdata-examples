...
proceso de estimación del total de víctimas por sexo (1985–2018). 
...
se estratificará por año del hecho, perpetrador y sexo. Para empezar, es necesario 
filtrar por las variables de "pertenece al conflicto", `is_conflict` ya que 
...
**yy_hecho**, **p_str** y **sexo** para cada réplica. El objeto **schema** contiene una 
...
-desagregado por perpetrador y sexo- para cada una de las réplicas. Por ejemplo, el 
elemento 151 de la lista contiene los hombres que fueron víctimas de otros grupos 
en el año de 1995 presentes en la réplica 1 (ver el objeto **victimas_estrato**:
...
contiene una columna con la réplica, una columna con el año, el perpetrador y el sexo. 
...
El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/homicidio-sexo-estimacion.html).
