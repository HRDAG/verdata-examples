...
saveRDS(resultados, here::here("Resultados-CEV/output-estratificacion/homicidio-yy_hecho-p_str.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/output/homicidio-anio-estimacion.html)
