...
proceso de estimación del total de víctimas por año del hecho (1985–2018). 
...
se estratificará por año del hecho y perpetrador. Para empezar, es necesario 
filtrar por las variables de "pertenece al conflicto", `is_conflict` 
...
-desagregado por perpetrador- para cada una de las réplicas. Por ejemplo, el 
elemento 151 de la lista contiene las víctimas de otras guerillas en el año 2006
...
contiene una columna con la réplica (R1), una columna con el año (2006) y el 
perpetrador. Nuevamente, este solo es un ejemplo de nuestra forma de estratificar,
...
saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-p_str-homicidio.rds"))

```

El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/homicidio-anio-estimacion.html).
