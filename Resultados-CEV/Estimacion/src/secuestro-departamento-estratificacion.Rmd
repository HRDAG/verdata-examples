...
que fueron secuestradas en el quinquenio de 1990 a 1994 presentes en la réplica
...
nuestro próximo ejemplo sobre [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/secuestro-departamento-estimacion.html).

```{r save-estratify, echo = TRUE}

saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-departamento-secuestro.rds"))
