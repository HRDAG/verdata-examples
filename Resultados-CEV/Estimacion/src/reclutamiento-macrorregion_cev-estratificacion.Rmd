...
subtitle: "Reclutamientos a menores de edad - 1990–2017"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
proceso de estimación del total de víctimas por macrorregion de la CEV (1990–2017). 
...
para cada una de las réplicas. Por ejemplo, el elemento 22 de la lista contiene
las víctimas de la macrorregion de Antioquia-Eje Cafetero que fueron reclutadas
...
estrato. Siguiendo el mismo ejemplo, el elemento 22 de **stratification_vars** 
...
victimas_estrato_nombre <- nombres[[22]]
...
próximo ejemplo sobre el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/reclutamiento-macrorregion-estimacion.html).

```{r save-estratify, echo = TRUE}

saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/quinquenio-macrorregion-reclutamiento.rds"))
