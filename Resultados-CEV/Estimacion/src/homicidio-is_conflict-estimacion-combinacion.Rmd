...
subtitle: "Total de víctimas vinculadas al conflicto armado - 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
vinculadas al conflicto armado (1985–2018).
...
total de víctimas vinculadas al conflicto armado (por perpetrador) solo 
procederemos a importar las estimaciones procedentes del [documento](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/homicidio-yy_hecho-estimacion-combinacion.html):

```{r leer-estimacion, echo = TRUE}
 
estimacion <- arrow::read_parquet(here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-is_conflict-perpetrador-homicidio.parquet"))
