...
como queremos estimar el subregistro de la presente violación por sexo,
se estratificará por año del hecho, la variable de "es desaparición forzada" y sexo. 
Para empezar, es necesario filtrar por las variables de "pertenece al conflicto", 
...
El siguiente paso es realizar el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-sexo-estimacion.html).
