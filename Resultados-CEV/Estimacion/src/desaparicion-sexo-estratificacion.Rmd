...
subtitle: "Desapariciones forzadas desagregados por sexo - 1985–2016"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
proceso de estimación del total de víctimas por sexo (1985–2016). 
...
presente violación por sexo, se estratificará por año del hecho, la variable de 
"es desaparición forzada" y sexo. Para empezar, es necesario filtrar por las 
...
schema <- ("replica,yy_hecho,is_forced_dis,sexo")
...
**yy_hecho**, **is_forced_dis** y **sexo** para cada réplica. El objeto **schema** contiene una 
...
las mujeres que fueron desaparecidas de forma forzada en el año de 1989 presentes en 
la réplica 1 (ver el objeto **victimas_estrato**:
...
contiene una columna con la respectiva réplica, una columna con el año, la variable
de desaparición forzada y el sexo. Nuevamente, este solo es un ejemplo de nuestra 
forma de estratificar,usted puede hacerlo de otra manera. La idea principal es 
agrupar las víctimas por las variables del estrato y las réplicas que esté usando.
...
próximo ejemplo sobre el proceso de [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/desaparicion-sexo-estimacion.html).
```{r save-estratify, echo = TRUE}

saveRDS(listas, 
        here::here("Resultados-CEV/Estimacion/output-estimacion/yy_hecho-is_forced_dis-sexo-desaparicion.rds"))
