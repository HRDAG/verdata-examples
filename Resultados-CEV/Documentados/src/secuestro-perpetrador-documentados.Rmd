...
informació y, considerando que usted pudo haber llegado a estos datos por medio 
...
Así, la función `confirm_files` autentica los archivos que han sido descargados. 
...
víctimas de esta violación, por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/secuestro-perpetrador-imputado.html) veremos que estas fueron objeto de la imputación estadística múltiple y 
...
`r myNum(tabla_documentada$observed[6])` fueron víctimas de los paramilitares.
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/secuestro-perpetrador-documentado.parquet"))
