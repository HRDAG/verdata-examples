...
En este ejemplo trabajaremos las réplicas 45 a la 55. Usted puede trabajar con 
...
van desde la número 45 hasta la 55. Además, nuestros datos tienen información 
...
Además, evidenciamos que no conocemos la etnia de `r myNum(tabla_documentada$observed[3])`
víctimas de esta violación, por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/reclutamiento-etnia-imputado.html) veremos que estas fueron objeto de la imputación estadística múltiple y 
