...
reclutamientos documentados (`r myNum(tabla_documentada$observed[1])` víctimas), 
seguido del año 2002 (`r myNum(tabla_documentada$observed[2])` víctimas), 1999 
...
que efectivamente fueron menores de edad; pero, ¿qué pasa con las víctimas 
sin información acerca de esta característica? Pues bien, esta
información (junto con la ya documentada) se abordará en el [próximo ejemplo sobre imputación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/reclutamiento-anio-imputado.html)
...
arrow::write_parquet(tabla_documentada,
                     here::here("CO-examples/Resultados-CEV/Documentados/output-documentados/reclutamiento-anio-documentado.parquet"))
