...
subtitle: "Secuestros desagregados por sexo - 1990–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
tabla 10 de la página 16 del [anexo metodológico del proyecto](https://www.comisiondelaverdad.co/anexo-proyecto-jep-cevhrdag).
...
último error significa que nos datos no se han leído a R. Si por alguna 
razón usted quiere leer dicha información a pesar de saber que no son los mismos 
datos originamente publicados, puede cambiar el argumento `crash` a FALSE, y, 
...
Siguiendo lo anteruor, la función `filter_standard_cev` nos permite transformar
...
en ocasiones contenían campos faltantes en algunas de las variables. Usaremos
...
víctimas de esta violación, por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/secuestro-sexo-imputado.html) veremos que estas fueron objeto de la imputación estadística múltiple y 
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/secuestro-sexo-documentado.parquet"))
