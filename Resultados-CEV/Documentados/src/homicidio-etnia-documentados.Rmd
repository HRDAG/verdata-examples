...
En este ejemplo trabajaremos las réplicas 90 a la 100. Usted puede trabajar con 
...
van desde la número 90 hasta la 100. Además, nuestros datos tienen información 
...
para el anexo metodológico (panorama homicidio), procederemos a transformar y/o filtrar 
algunas variables. 
...
víctimas de esta violación, por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/homicidio-etnia-imputado.html) veremos que estas fueron objeto de la imputación estadística múltiple y 
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/homicidio-etnia-documentado.parquet"))
