...
subtitle: "Homicidios desagregados por macroregion de la CEV - 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/homicidio-macroregion-imputado.html) veremos que estas fueron objeto de la imputación
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/homicidio-macroregion-documentado.parquet"))
