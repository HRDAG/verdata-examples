...
en ocasiones contenían campos faltantes en algunas de las variables. Usaremos la 
función `summary_observed` para calcular dicha documentación.
...
que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/homicidio-is_conflict-imputado.html) veremos que estas fueron objeto de la imputación
...
fenómeno, no es correcto incluir estas víctimas, ya que estos homicidios 
ocurrieron en otros contextos (de acuerdo con las fuentes que
las documentaron). Pero, por otro lado, vemos que `r myNum(tabla_documentada$observed[2])` 
personas sí fueron víctimas dentro de este marco (de acuerdo con dichas fuentes).
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/homicidio-is_conflict-documentado.parquet"))
