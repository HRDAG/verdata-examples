...
subtitle: "Reclutamientos a menores de edad desagregados por macroregion de la CEV - 1990–2017"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
víctimas mayores de edad y también a aquellas en las que existía ambiguedad de 
sobre esta característica (es decir, que presentan campos faltantes),
por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/reclutamiento-macroregion-imputado.html) veremos que estas fueron objeto de la imputación
...
en la macroregion de `r myNum(tabla_documentada$macroregion[1])` 
mientras que `r myNum(tabla_documentada$observed[2])`
fueron reclutadas en la macroregion de `r myNum(tabla_documentada$macroregion[2])`
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/reclutamiento-macroregion-documentado.parquet"))
