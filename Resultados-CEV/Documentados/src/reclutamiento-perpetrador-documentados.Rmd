...
víctimas adultas y también a aquellas en las que existía ambiguedad respecto
a esta característica (es decir, que presentan campos faltantes).
Además, evidenciamos que no conocemos el perpetrador de `r myNum(tabla_documentada$observed[8])`
víctimas de esta violación, por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/reclutamiento-perpetrador-imputado.html) veremos que estas fueron objeto de la imputación estadística múltiple y 
...
personas fueron documentadas como víctimas de las FARC-EP mientras que `r myNum(tabla_documentada$observed[6])`
fueron víctimas de los paramilitares.
...
Informe Final de dicha institución (capítulo de Niños y Niñas).
