...
secuestros documentados (`r myNum(tabla_documentada$observed[1])` víctimas), 
seguido del año 2002 (`r myNum(tabla_documentada$observed[2])` víctimas), 2001 
...
información (junto con la ya documentada) se abordará en el [próximo ejemplo sobre imputación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/secuestro-anio-imputado.html) en el que también graficaremos nuestros resultados a nivel documentado e imputado.
...
cálculo de la combinación de las imputaciones (o réplicas) (o versiones de los datos) 
acorde con las reglas de *combinación* de Rubin.

```{r save-observed, echo = TRUE}

arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/secuestro-anio-documentado.parquet"))
