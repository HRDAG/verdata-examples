...
información (junto con la ya documentada) se abordará en el [próximo ejemplo sobre imputación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/secuestro-anio-imputado.html) en el que también graficaremos nuestros resultados a 
nivel documentado e imputado.
