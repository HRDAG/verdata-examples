...
por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/homicidio-departamento-imputado.html) veremos que estas fueron objeto de la imputación
...
arrow::write_parquet(tabla_departamento,
                     here::here("Resultados-CEV/Documentados/output-documentados/homicidio-departamento-documentado.parquet"))
