...
de víctimas documentadas de acuerdo con su relación con el conflicto armado. Como 
se ha indicado en otros ejemplos y el anexo, todas las víctimas de reclutamiento 
están relacionadas con el conflicto armado, por lo que acá no vemos víctimas con
valor de cero en dicha variable. No obstante, estas son víctimas de las que 
sabemos son menores de edad, es decir, acá excluímos víctimas mayores de 18 años
y también a aquellas de las que no sabemos si son o no menores de dicha edad, por
lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/reclutamiento-is_conflict-imputado.html) veremos que estas fueron objeto de la imputación
estadística múltiple y que por ende estas víctimas "pasaron" a ser parte de una 
de las categorías de esta variable de "is_conflict".
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/reclutamiento-is_conflict-documentado.parquet"))
