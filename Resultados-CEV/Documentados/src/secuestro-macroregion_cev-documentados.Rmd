...
subtitle: "Secuestros desagregados por macroregion de la CEV - 1990–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/secuestro-macroregion-imputado.html) veremos que estas fueron objeto de la imputación
