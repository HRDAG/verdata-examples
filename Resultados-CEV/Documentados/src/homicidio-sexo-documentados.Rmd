...
víctimas de esta violación, por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/homicidio-sexo-imputado.html) veremos que estas fueron objeto de la imputación estadística múltiple y 
