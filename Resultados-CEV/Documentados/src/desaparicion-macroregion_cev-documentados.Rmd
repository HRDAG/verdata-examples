...
subtitle: "Desapariciones forzadas desagregadas por macroregion de la CEV - 1986–2016"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/desaparicion-macroregion-imputado.html) veremos que estas fueron objeto de la imputación
...
`r myNum(tabla_documentada$observed[1])` personas fueron víctimas 
en la macroregion de `r myNum(tabla_documentada$macroregion[1])` 
mientras que `r myNum(tabla_documentada$observed[2])`
fueron víctimas en la macroregion de `r myNum(tabla_documentada$macroregion[2])`
...
arrow::write_parquet(tabla_documentada,
                     here::here("Resultados-CEV/Documentados/output-documentados/desaparicion-macroregion-documentado.parquet"))
