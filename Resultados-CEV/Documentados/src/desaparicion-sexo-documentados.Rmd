...
tabla 7 de la página 15 del [anexo metodológico del proyecto](https://www.comisiondelaverdad.co/anexo-proyecto-jep-cevhrdag).
...
Es momentode obtener la información de las víctimas documentadas por nuestra variable de interés. 
...
documentadas dentro del marco del conflicto armado y desaparecidas de forma foezada,
es decir, excluimos aquellas víctimas no relacionadas y también a aquellas en 
las que existía ambiguedad de si hacían parte o no de dichos fenómenos (es decir,
que presentan campos faltantes).Además, evidenciamos que no conocemos el sexo de `r myNum(tabla_documentada$observed[3])` víctimas de esta violación, por lo que en el siguiente [ejemplo](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Imputacion/output/desaparicion-sexo-imputado.html) veremos que estas fueron objeto de la imputación estadística múltiple y 
que por ende estas víctimas "pasaron" a ser parte de una de estas categorías. 
Seguido de esto vemos que `r myNum(tabla_documentada$observed[1])`
