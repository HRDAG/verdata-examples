...
víctimas no vinculadas a estos fenómenos y personas que tenían campos faltantes allí.
...
`r myNum(tabla_combinada$observed[8])` se imputaron y por ende dichas personas 
