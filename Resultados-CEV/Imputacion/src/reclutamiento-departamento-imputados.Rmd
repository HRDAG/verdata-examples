...
subtitle: "Reclutamientos a menores de edad desagregado por departamento del hecho - 1990–2017"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/reclutamiento-departamento-documentado.html) sobre el cálculo de víctimas documentadas para 
...
tabla_documentada <- arrow::read_parquet(here::here("Resultados-CEV/Documentados/output-documentados/reclutamiento-departamento-documentado.parquet"))
...
fueron víctimas menores de edad; pero, ¿qué hay de las víctimas sin información 
acerca de esta característica? Pues bien, esta información (junto con la ya 
documentada) se encuentra en la barra azul, la cual muestra 
...
incluyendo aquellas víctimas para las que no teniamos conocimiento de si eran
...
ejemplo) en contraste con los patrones de violencia a partir de la [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/reclutamiento-departamento-estimacion.html)

```{r save-observed, echo = TRUE}

arrow::write_parquet(diez_primeros_departamentos,
                     here::here("Resultados-CEV/Imputacion/output-imputados/reclutamiento-departamento-imputados.parquet"))
```
