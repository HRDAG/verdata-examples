...
subtitle: "Desapariciones forzadas vinculadas al conflicto armado - 1985–2016"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
`r myNum(tabla_combinada$imp_hi[1])` víctimas desaparecidas de forma forzada
vinculadas al conflicto armado, con un promedio de `r myNum(tabla_combinada$imp_mean[1])`. 
