...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/desaparicion-sexo-documentado.html) sobre el cálculo de víctimas documentadas para 
...
cual aplica únicamente esta violación. Esta indica si la víctima
...
víctimas no vinculadas a estos fenómenos y víctimas que tenían campos faltantes 
