...
subtitle: "Secuestros desagregados por macroregiones de la CEV- 1990–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
adicionales como quinquenio, más categorías de edades, etc.^[Adicionalmente, 
...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/secuestro-macroregion-documentado.html) sobre el cálculo de víctimas documentadas para 
...
tabla_documentada <- arrow::read_parquet(here::here("Resultados-CEV/Documentados/output-documentados/secuestro-macroregion-documentado.parquet"))
...
ejemplo) en contraste con los patrones de violencia a partir de la [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/secuestro-macroregion-estimacion.html)

```{r save-observed, echo = TRUE}

arrow::write_parquet(diez_primeros_macroregions,
                     here::here("Resultados-CEV/Imputacion/output-imputados/secuestro-macroregion-imputados.parquet"))
```
