...
subtitle: "Homicidios desagregados por macroregiones de la CEV- 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/homicidio-macroregion-documentado.html) sobre el cálculo de víctimas documentadas para 
...
tabla_documentada <- arrow::read_parquet(here::here("Resultados-CEV/Documentados/output-documentados/homicidio-macroregion-documentado.parquet"))
...
ejemplo) en contraste con los patrones de violencia a partir de la [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/homicidio-macroregion-estimacion.html)

```{r save-observed, echo = TRUE}

arrow::write_parquet(diez_primeros_macroregions,
                     here::here("Resultados-CEV/Imputacion/output-imputados/homicidio-macroregion-imputados.parquet"))
```
