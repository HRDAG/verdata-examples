...
subtitle: "Homicidios desagregados por macrorregiones de la CEV- 1985–2018"
output:
  rmdformats::robobook:
    code_folding: show
    self_contained: true
...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/homicidio-macrorregion-documentado.html) sobre el cálculo de víctimas documentadas para 
...
ejemplo) en contraste con los patrones de violencia a partir de la [estimación y combinación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Estimacion/output/homicidio-macrorregion-estimacion.html)

```{r save-observed, echo = TRUE}

arrow::write_parquet(tabla_combinada,
                     here::here("Resultados-CEV/Imputacion/output-imputados/homicidio-macrorregion-imputados.parquet"))
```
