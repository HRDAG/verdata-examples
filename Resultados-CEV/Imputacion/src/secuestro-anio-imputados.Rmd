...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/secuestro-anio-documentado.html) sobre el cálculo de víctimas documentadas para 
esta misma variable (con la función `summary_observed`). Esta información 
-previamente calculada- la importaremos desde nuestra carpeta "output-documentados". 

```{r import-observed, echo = TRUE}

tabla_documentada <-  arrow::read_parquet(here::here("Resultados-CEV/Documentados/output-documentados/secuestro-anio-documentado.parquet"))
...
con los patrones de violencia a partir de la [estimación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/secuestro-anio-estimacion.html) y posterior [combinacion](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/secuestro-anio-documentado.html).

```{r save-observed, echo = TRUE}

arrow::write_parquet(tabla_combinada,
                     here::here("Resultados-CEV/Documentados/output-imputados/secuestro-anio-imputados.parquet"))
```
