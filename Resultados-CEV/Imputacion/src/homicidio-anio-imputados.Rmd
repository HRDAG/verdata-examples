...
documentada, la misma que se obtuvo en el [ejemplo sobre víctimas documentadas](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentado/output/homicidio-anio-documentado.html) sobre el cálculo de víctimas documentadas para 
...
tabla_documentada <-  arrow::read_parquet(here::here("Resultados-CEV/Documentados/output-documentados/homicidio-anio-documentado.parquet"))
...
documentados; esta documentación se refiere a víctimas wobre las cuales sabemos 
que efectivamente fueron víctimas dentro del marco del conflicto, pero, ¿qué pasa
...
Por último, gurdamos los resultados (en formato *.parquet*) 
en una carpeta denominada "output-imputados", ya que 
...
con los patrones de violencia a partir de la [estimación](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/homicidio-anio-estimacion.html) y posterior [combinacion](https://github.com/HRDAG/CO-examples/blob/main/Resultados-CEV/Documentados/output/homicidio-anio-documentado.html).

```{r save-observed, echo = TRUE}

arrow::write_parquet(tabla_combinada,
                     here::here("Resultados-CEV/Documentados/output-imputados/homicidio-anio-imputados.parquet"))
```
