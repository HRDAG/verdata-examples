...
tabla_documentada <- tabla_documentada %>% 
    mutate(is_conflict = as.logical(is_conflict)) %>% 
...
de víctimas documentadas de acuerdo con su relación con el conflicto armado. Estas 
`r myNum(tabla_combinada$observed[3])` se imputaron y por ende dichas personas 
"pasaron" a algunas de las dos categorías de nuestro interés y que se representan en
**imp_mean**. Es decir, recordemos que estas nuevas columnas incluyen todas las
víctimas, independientemente si pasaron por un proceso de imputación o no.
